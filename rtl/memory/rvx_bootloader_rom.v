...
module rvx_bootloader_rom #(
  ...
  initial begin
    ...
    if (!ENABLE_E) begin
      ...
      rom[98]  = 32'h00001637;
      rom[99]  = 32'h00F52223;
      rom[100] = 32'h00468693;
      rom[101] = 32'h000017B7;
      rom[102] = 32'h00860613;
      rom[103] = 32'h0007A283;
      rom[104] = 32'h0006A683;
      rom[105] = 32'h00062603;
      rom[106] = 32'h00C7A583;
      rom[107] = 32'h00E287B3;
      rom[108] = 32'h0017B793;
      rom[109] = 32'h00658733;
      rom[110] = 32'h00173713;
      rom[111] = 32'h00E7F7B3;
      rom[112] = 32'h08078663;
      rom[113] = 32'h00060067;
      rom[114] = 32'h525665B7;
      rom[115] = 32'h525632B7;
      rom[116] = 32'h83458593;
      rom[117] = 32'h33228293;
      rom[118] = 32'h000013B7;
      rom[119] = 32'h0053A023;
      rom[120] = 32'h00D3A223;
      rom[121] = 32'h00C3A423;
      rom[122] = 32'h00B3A623;
      rom[123] = 32'h01000313;
      rom[124] = 32'h40003737;
      rom[125] = 32'h02000293;
      rom[126] = 32'h04D37263;
      rom[127] = 32'h00000593;
      rom[128] = 32'h00000513;
      rom[129] = 32'h00072623;
      rom[130] = 32'h01472783;
      rom[131] = 32'h0017F793;
      rom[132] = 32'hFE079CE3;
      rom[133] = 32'h01072783;
      rom[134] = 32'h0FF7F793;
      rom[135] = 32'h00B797B3;
      rom[136] = 32'h00858593;
      rom[137] = 32'h00F56533;
      rom[138] = 32'hFC559EE3;
      rom[139] = 32'h006387B3;
      rom[140] = 32'h00A7A023;
      rom[141] = 32'h00430313;
      rom[142] = 32'hFCD362E3;
      rom[143] = 32'h400037B7;
      rom[144] = 32'h00100713;
      rom[145] = 32'h00E7A223;
      rom[146] = 32'h00060067;
      rom[147] = 32'h5B50006F;
      rom[148] = 32'hF89FF06F;
    end
  end
