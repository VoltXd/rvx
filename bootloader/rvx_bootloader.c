...
__attribute__((always_inline)) inline static uint32_t read_word_from_spi()
{
  ...
  for (int i = 0; i < 4; i++)
  {
    uint8_t byte = rvx_spi_transfer((RvxSpiRegs*)RVX_SPI_CONTROLLER_ADDRESS, 0x00);
...
RVX_NAKED void rvx_bootloader(void)
{
  ...
  rvx_spi_assert_cs((RvxSpiRegs*)RVX_SPI_CONTROLLER_ADDRESS);
  rvx_spi_transfer((RvxSpiRegs*)RVX_SPI_CONTROLLER_ADDRESS, 0x03); // Read Data command
  rvx_spi_transfer((RvxSpiRegs*)RVX_SPI_CONTROLLER_ADDRESS, addr_byte_1);
  rvx_spi_transfer((RvxSpiRegs*)RVX_SPI_CONTROLLER_ADDRESS, addr_byte_2);
  rvx_spi_transfer((RvxSpiRegs*)RVX_SPI_CONTROLLER_ADDRESS, addr_byte_3);
  ...
  {
    rvx_spi_deassert_cs((RvxSpiRegs*)RVX_SPI_CONTROLLER_ADDRESS);
